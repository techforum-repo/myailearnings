 ...
 */
package com.techforum.generativeai.core.models;
...
import com.techforum.generativeai.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "GenerativeAI/components/helloworld");
